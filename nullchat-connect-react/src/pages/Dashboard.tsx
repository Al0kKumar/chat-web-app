...
// // Temp placeholder until real API data is fetched
// const conversations: any[] = []; // Replace with actual fetched list from backend soon
...
//   return (
//     <div className="h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col w-full md:w-96 border-r border-white/10">
//       {/* Header */}
...
//                     {/* Optional: AvatarImage can be added when available */}
